    ...
    <div>
        ...
        <div class='headers'>
            <div class='header-logo'>
                <img src='static/images/waterlogo.png' alt='用户头像' />
                <span>中小型骨干水源工程监管云</span>
            </div>
            <div class='header-info'>
                <div :class='showOverviewContent?"active":""' @click='toggleOverviewContent'>
                    <a>总概览</a>
                </div>
                <div :class='showCommissionContent?"active":""' @click='toggleCommissionContent'>
                    <a>菜单</a>
                </div>
        ...
        <transition name="slide-fade">
            <div class='overview-details' v-if='showOverviewContent'>
                ...
                <div class='overview-content transverse-version'>
                    ...
                    <div class='chart-block'>
                        ...
                        <div id="program_funnel_parent">
                            <div id='program_funnel' style="width:100%;height:230px;margin-top:30px;"></div>
                        </div>
                    </div>
                    <div class='chart-block'>
                        <div class='map-title'>
        ...
        <transition name="slide-fade">
            ...
            <div class='overview-commission' v-if='showCommissionContent'>
                ...
                <div class='commission-content'>
                    ...
                    <el-menu :default-active="activeNode" class="el-menu-demo" mode="horizontal" background-color="#080808" text-color="#fff" active-text-color="#ffd04b" :router="routeFlag">
                        ...
                        <div v-for="(item, index) in menuData" :key="index">
                            <el-submenu :index="item.name" v-if="item.children && item.children.length > 0">
                                ...
                                <el-menu-item v-for="(node, i) in item.children" :key="i" :index="node.path">{{ node.name }}</el-menu-item>
                            </el-submenu>
