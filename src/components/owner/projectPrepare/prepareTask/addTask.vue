        ...
        <el-row :gutter="20">
            ...
            <el-col :lg="12" :md="12" :xs="24">
                <el-form-item label="批复时间：" prop="approvalDate">
                    <el-date-picker v-model="form.approvalDate" type="date" placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss">
                    </el-date-picker>
                </el-form-item>
            </el-col>
            <el-col :lg="12" :md="12" :xs="24">
            ...
            <el-col :lg="24" :md="24" :xs="24">
                <div style="text-align:center;">
                    <el-button type="primary" size="small" @click="submitAll">提交计划</el-button>
...
export default {
    ...
    methods: {
        getNextNode() {
            this.$http.get('/api/preprogress/nextnode').then(res => {
        ...
        submitPlan() {
            this.$http.post('/api/preprogress', this.form).then(res => {
                if (res.code === 1002) {
