<template>
    <el-form ref="form" :model="form" label-width="160px" class="project-form" :rules="rules">
            ...
            <el-row :gutter="20">
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="项目所属">
                        <el-radio-group v-model="form.affiliatedTo" size="medium" prop="affiliatedTo">
                            <el-radio-button label="govern">水利厅直管</el-radio-button>
                            <el-radio-button label="corp">水投直管</el-radio-button>
                        </el-radio-group>
                    </el-form-item>
                ...
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="项目名称" prop="plantName">
                        <el-input v-model="form.plantName"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="12" :md="12" :xs="12">
                    <el-form-item label="项目法人" prop="legalPersonName">
                ...
                <el-col :lg="12" :md="12" :xs="12">
                    <el-form-item label="所在县">
                        ...
                        <el-cascader :options="options" :show-all-levels="false" ref="regionSelector" @change="selectedRegion"></el-cascader>
                    </el-form-item>
                </el-col>
                <el-col :lg="12" :md="12" :xs="12">
        ...
        <el-card class="box-card">
            ...
            <el-row :gutter="20">
                ...
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="工程级别" prop="level">
                ...
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="溢洪道（m）" prop="spillway">
                        <el-input v-model="form.spillway"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="灌溉面积(万亩）" prop="irrigatedArea">
                        <el-input v-model="form.irrigatedArea"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="积水面积（m）" prop="catchmentArea">
                        <el-input v-model="form.catchmentArea"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="度汛高程" prop="floodControlElevation">
                        <el-input v-model="form.floodControlElevation"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="总库容" prop="storage">
                        <el-input v-model="form.storage"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="兴利库容" prop="utilizablCapacity">
                        <el-input v-model="form.utilizablCapacity"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="装机容积（Kw）" prop="installedCapacity">
                        <el-input v-model="form.installedCapacity"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="12" :md="12" :xs="12">
                    <el-form-item label="城镇供水人口（万人)" prop="waterSupplyPopulation">
                        <el-input v-model="form.waterSupplyPopulation"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="12" :md="12" :xs="12">
                    <el-form-item label="农村人饮（万人）" prop="ruralHumanWater">
                        <el-input v-model="form.ruralHumanWater"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="12" :md="12" :xs="12">
                    <el-form-item label="大牲畜（万头）" prop="livestock">
                        <el-input v-model="form.livestock"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="12" :md="12" :xs="12">
                    <el-form-item label="供水量（万m³/年)" prop="watersupply">
        ...
        <el-card class="box-card">
            ...
            <el-row :gutter="20">
                ...
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="工期（月）" prop="timeLimit">
                ...
                <el-col :lg="8" :md="12" :xs="12">
                    <el-form-item label="工程占地（亩）" prop="areaCoverage">
                ...
                <el-col :lg="8" :md="8" :xs="12">
                    <el-form-item label="单位工程数" prop="unitProjectAmount">
                        <el-input v-model="form.unitProjectAmount"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8" :md="8" :xs="12">
                    <el-form-item label="单元工程数" prop="cellProjectAmount">
                        <el-input v-model="form.cellProjectAmount"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="8" :md="8" :xs="12">
                    <el-form-item label="分布工程数" prop="branchProjectAmount">
                        <el-input v-model="form.branchProjectAmount"></el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="项目概况" prop="overview">
                        <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="form.overview">
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="工程任务及主要建筑物">
                        <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="form.projectTask">
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="建设用地">
                        <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="form.constructionLand">
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="土地复垦方案">
                        <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="form.landReclamationPlan">
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="单位工程概况">
                        <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="form.unitProjectOverview">
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="单元工程概况">
                        <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="form.cellProjectOverview">
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="24" :md="24" :xs="24">
                    <el-form-item label="分布工程概况">
                        <el-input type="textarea" :rows="5" placeholder="请输入内容" v-model="form.branchProjectOverview">
                        </el-input>
                    </el-form-item>
                </el-col>
                <el-col :lg="24" :md="24" :xs="24">
        ...
        <div class="tool-bar">
            <el-button type="primary" @click="detailSubmit">提交</el-button>
        </div>
    </el-form>
</template>
                    ...
                    if (files && files.length > 0) {
                        ...
                        this.$http.post('/api/file/uploadtempfiles', fd).then(res => {
                            if (res.code === 1002) {
                                ...
                                this.$http.post('/api/baseinfo', this.form).then(result => {
                                    if (result.code === 1002) {
                                ...
                                this.$alert(res.msg, '错误', {type: 'warning'})
                            }
                        })
                    } else {
                        this.$http.post('/api/baseinfo', this.form).then(result => {
