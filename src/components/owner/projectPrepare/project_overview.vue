<template>
  <div class="project-overview">
    ...
    <el-tabs v-model="activeName"
             class="project-info">
      <el-tab-pane label="水库信息"
                   name="info">
        <project-info :infoData="infoData"
                      v-if="activeName === 'info'"></project-info>
      </el-tab-pane>
      <el-tab-pane label="附件"
                   name="attachment">
        <project-attachment :attachmentData="attachmentData"
                            v-if="activeName === 'attachment'"></project-attachment>
      </el-tab-pane>
    </el-tabs>
  </div>
</template>
