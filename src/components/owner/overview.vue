<template>
    <div class="owner-overview">
        <el-row :gutter="20">
            ...
            <el-col :lg="18" :md="18" :xs="24">
                <div class="overview-notice">
                    ...
                    <div class="notice-content" v-if="noticeList.length > 0">
                        <div v-for="item in noticeList" :key="item.announcementId">
            ...
            <el-col :lg="6" :md="6" :xs="24" class="reservoir-info">
                <div>
                    <span>库</span>
                    <div class="overview-detail">
                        ...
                        <div>
                            <span>法人：</span>
                            <span :title="reservoir.legalRepresentativeName" class="owner-person">{{ reservoir.legalRepresentativeName }}</span>
                        </div>
                        <div>
                            <span>规模：</span>
                ...
                <div>
                    ...
                    <el-button type="primary" icon="fa fa-pencil-square-o fa-3x" @click="adjustProjectInfo">项目填报</el-button>
                    <el-button type="info" icon="fa fa-folder-open-o fa-3x" @click="$router.push({path: '/projectprepare/preparetask'})">项目管理</el-button>
                    <el-button type="success" icon="fa fa-folder-o fa-3x" @click="$router.push({path: '/tenders'})">招标管理</el-button>
                    <el-button type="warning" icon="fa  fa-files-o fa-3x" @click="$router.push({path: '/investmentfinancing'})">投资管理</el-button>
                </div>
            </el-col>
        ...
        <el-row :gutter="20" class="chart-row">
            ...
            <el-col :lg="8" :md="8" :xs="24">
                <div id='rain_fall' style="height:200px; width:100%"></div>
            </el-col>
            <el-col :lg="8" :md="8" :xs="24">
                <div id='water_height' style="height:200px; width:100%"></div>
            </el-col>
            <el-col :lg="8" :md="8" :xs="24">
                <div id='water_flow' style="height:200px; width:100%"></div>
            </el-col>
        </el-row>
    </div>
</template>
