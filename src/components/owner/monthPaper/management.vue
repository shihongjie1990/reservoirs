<template>
  <div class="paper-management">
    <div class="title page-title"><span>月报管理</span></div>
    <el-collapse v-model="activeNames"
                 class="centerline-panel page-content">
      <el-collapse-item v-for="(itemData, key, index) in showData"
                        :key="index"
                        :title="key"
                        :name="index">
        <div class="content">
          <el-row :gutter="15"
                  ...
                  class="self-icon-positon">
            <el-col :sm="8"
                    :md="6"
                    :lg="4"
                    :xl="4"
                    :xs="8"
                    v-for="child in itemData"
                    :key="child.projectMonthlyReportId">
              <el-card :body-style="{ padding: '0px' }"
                       shadow="hover">
                <div class="card-img"
                     @click="$router.push({name:'月报详情', params:{monthPaper:child}})">
                  <img :src="child.url"
                       class="image">
                </div>
                ...
                <div v-if="child.state === 1">
                  <el-tag type="success"
                          class="state-position">{{ child.stateText }}</el-tag>
                </div>
                ...
                <div class="card-info">
                  ...
                  <i class="fa fa-trash-o"
                     @click="paperDelete(child.projectMonthlyReportId)"></i>
