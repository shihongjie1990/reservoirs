<template>
    <div class="owner-paper">
        <el-steps :active="activeNum" simple>
            <el-step title="基础信息" icon="fa fa-edit fa-lg"></el-step>
            <el-step title="投资情况" icon="fa fa-rmb fa-lg"></el-step>
            <el-step title="工程量情况" icon="fa fa-building fa-lg"></el-step>
            <el-step title="项目情况" icon="fa fa-folder-open-o fa-lg"></el-step>
            <el-step title="附件" icon="fa fa-image fa-lg"></el-step>
        </el-steps>
        <div class="paper-base" v-show="activeNum === 1">
            <el-form ref="form1" :rules="rules" :model="baseForm" label-width="120px">
                <el-row :gutter="20">
                    <el-col :span="22">
                        <el-form-item label="上报人" prop="submitter">
                ...
                <el-row :gutter="20">
                    <el-col :span="22">
                        <el-form-item label="统计负责人" prop="statisticalLeader">
                ...
                <el-row :gutter="20">
                    <el-col :span="22">
                        <el-form-item label="填报月份" prop="submitDate">
                            <el-date-picker v-model="baseForm.submitDate" type="month" placeholder="选择月" value-format="yyyy-MM">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                </el-row>
        ...
        <div class="investment-status" v-show="activeNum === 2">
            <el-form ref="investmentForm" :model="investmentForm" label-width="220px" :rules="rules2">
                <div>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="建筑工程(万元)" prop="civilEngineering">
                                <el-input v-model="investmentForm.civilEngineering" @keyup.native="changeValue('civilEngineering')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="机电设备及安装工程(万元)" prop="electromechanicalEquipment">
                                <el-input v-model="investmentForm.electromechanicalEquipment" @keyup.native="changeValue('electromechanicalEquipment')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="金属机构设备及安装工程(万元)" prop="metalMechanism">
                                <el-input v-model="investmentForm.metalMechanism" @keyup.native="changeValue('metalMechanism')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="施工临时工程(万元)" prop="temporaryWork">
                                <el-input v-model="investmentForm.temporaryWork" @keyup.native="changeValue('temporaryWork')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="独立费用(万元)" prop="independentCost">
                                <el-input v-model="investmentForm.independentCost" @keyup.native="changeValue('independentCost')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                ...
                <div>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="建设征地移民安置补偿费(万元)" prop="resettlementArrangement">
                                <el-input v-model="investmentForm.resettlementArrangement" @keyup.native="changeValue('resettlementArrangement')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="水土保持工程投资(万元)" prop="waterConservation">
                                <el-input v-model="investmentForm.waterConservation" @keyup.native="changeValue('waterConservation')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="环境保护工程投资(万元)" prop="environmentalProtection">
                                <el-input v-model="investmentForm.environmentalProtection" @keyup.native="changeValue('environmentalProtection')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="其他(万元)" prop="otherCost">
                                <el-input v-model="investmentForm.otherCost" @keyup.native="changeValue('otherCost')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                ...
                <div>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="中央投资(万元)" prop="sourceCentralInvestment">
                                <el-input v-model="investmentForm.sourceCentralInvestment" @keyup.native="changeValue('sourceCentralInvestment')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="省级投资(万元)" prop="sourceProvincialInvestment">
                                <el-input v-model="investmentForm.sourceProvincialInvestment" @keyup.native="changeValue('sourceProvincialInvestment')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="市县投资(万元)" prop="sourceLocalInvestment">
                                <el-input v-model="investmentForm.sourceLocalInvestment" @keyup.native="changeValue('sourceLocalInvestment')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                ...
                <div>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="中央投资(万元)" prop="availableCentralInvestment">
                                <el-input v-model="investmentForm.availableCentralInvestment" @keyup.native="changeValue('availableCentralInvestment')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="省级投资(万元)" prop="availableProvincialInvestment">
                                <el-input v-model="investmentForm.availableProvincialInvestment" @keyup.native="changeValue('availableProvincialInvestment')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="市县投资(万元)" prop="availableLocalInvestment">
                                <el-input v-model="investmentForm.availableLocalInvestment" @keyup.native="changeValue('availableLocalInvestment')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
        ...
        <div class="investment-status" v-show="activeNum === 3">
            <el-form ref="engineerForm" :model="investmentForm" label-width="220px" :rules="rules3">
                <div>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="土石方明挖（万/m³）" prop="openDug">
                                <el-input v-model="investmentForm.openDug" @keyup.native="changeValue('openDug')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="土石方洞挖（万/m³）" prop="holeDug">
                                <el-input v-model="investmentForm.holeDug" @keyup.native="changeValue('holeDug')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="土石方回填（万/m³）" prop="backfill">
                                <el-input v-model="investmentForm.backfill" @keyup.native="changeValue('backfill')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="砌石（万/m³）" prop="masonry">
                                <el-input v-model="investmentForm.masonry" @keyup.native="changeValue('masonry')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="混凝土（万/m³）" prop="concrete">
                                <el-input v-model="investmentForm.concrete" @keyup.native="changeValue('concrete')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="钢筋（t）" prop="rebar">
                                <el-input v-model="investmentForm.rebar" @keyup.native="changeValue('rebar')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                    ...
                    <el-row :gutter="20">
                        <el-col :span="8">
                            <el-form-item label="灌浆（m或m³）" prop="grout">
                                <el-input v-model="investmentForm.grout" @keyup.native="changeValue('grout')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
                        ...
                        <el-col :span="8">
                            <el-form-item label="劳动力投入（万工日）" prop="labourForce">
                                <el-input v-model="investmentForm.labourForce" @keyup.native="changeValue('labourForce')"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="2">
        ...
        <div class="project-situation" v-show="activeNum === 4">
            <el-form ref="projectForm" :model="projectForm" label-width="180px">
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="主要建设内容">
                            <el-input v-model="projectForm.constructionContent" type="textarea" :rows="4" placeholder="请输入内容"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="工程形象进度及节点工期">
                            <el-input v-model="projectForm.visualProgress" type="textarea" :rows="4" placeholder="请输入内容"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="存在困难及问题">
                            <el-input v-model="projectForm.difficulty" type="textarea" :rows="4" placeholder="请输入内容"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="采取的主要措施">
                            <el-input v-model="projectForm.measure" type="textarea" :rows="4" placeholder="请输入内容"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item label="下一步建议">
                            <el-input v-model="projectForm.suggestion" type="textarea" :rows="4" placeholder="请输入内容"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="备注">
                            <el-input v-model="projectForm.remark" type="textarea" :rows="4" placeholder="请输入内容"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
        </div>
        <div class="attachment" v-show="activeNum === 5">
            <el-upload class="upload-file" ref="upload" action="" drag multiple :auto-upload="false" :file-list="fileList" list-type="picture" style="width:100%">
                <i class="el-icon-upload"></i>
                <div class="el-upload__text">将文件拖到此处，或<em>点击上传</em></div>
            </el-upload>
        </div>
        <div class="toolbar">
            <el-button :type="activeNum === 1 ? 'info' : 'primary'" plain :disabled="activeNum === 1 ? true : false" @click="activeNum--">上一步</el-button>
            <el-button v-if="activeNum < 5" type="primary" @click="nextStep">下一步</el-button>
            <el-button v-if="activeNum === 5" type="success" @click="fileUpload">提交</el-button>
