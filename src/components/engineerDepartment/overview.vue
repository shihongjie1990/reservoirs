<template>
  <div class="one-map">
    ...
    <div class='filter-search'>
        ...
        >
          ...
          <el-dropdown-menu slot='dropdown'>
            <el-dropdown-item
              ...
              :key='item.regionCode'
            >{{item.regionName}}</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
        ...
        >
          ...
          <el-dropdown-menu slot='dropdown'>
            <el-dropdown-item
              ...
              :key='item.baseInfoId'
            >{{item.plantName}}</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
      <div
      ...
      >
        <el-input
          ...
          @keyup.native.enter.stop='searchReservoir'
        ></el-input>
        <i
          class='el-icon-search'
          @click='searchReservoir'
        ></i>
      </div>
    </div>
    <transition name='fade-right'>
      <div
        class='marker-chart marker-chart1'
        v-if='showReservoirDetail'
      >
        <div
          id='rain_fall'
          class='overview-rainfall'
        ></div>
    ...
    <transition name='fade-right'>
      <div
        class='marker-chart marker-chart3'
        v-if='showReservoirDetail'
      >
        <div
          id='water_height'
    ...
    <transition name='fade-right'>
      ...
      <div
        class='marker-chart marker-chart2'
        v-if='showReservoirDetail'
      >
        <div
          id='water_flow'
    ...
    <transition name='slide-fade'>
      ...
      >
        ...
        <div
          ...
          @click='showReservoirDetail = false'
        >x</div>
