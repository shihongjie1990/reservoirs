<template>
    <div class="reservoir-list">
        <div class="reservoir-operation">
            <el-button type="warning" size="small" @click="modifyReservoir"><i class="fa fa-edit"></i> 信息修改</el-button>
            <el-button type="info" size="small" @click="deleteReservoir"><i class="fa fa-trash-o"></i> 水库删除</el-button>
        </div>
        <div class="reservoir-search">
            <el-input placeholder="请输入水库名称" suffix-icon="el-icon-search" v-model="plantName" @keyup.native.enter="searchReservoir">
            </el-input>
        </div>
        <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%; font-size:13px" border :header-cell-style="{background:'#e0e0e0',fontSize:'14px'}" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="水库名" align="center" show-overflow-tooltip width='140'>
                <template slot-scope='scope'><a class='reservoir-a' @click="skipTo(scope.row)">{{scope.row.plantName}}</a></template>
            </el-table-column>
            <el-table-column prop="scale" label="水库规模" show-overflow-tooltip align="center">
            </el-table-column>
            <el-table-column prop="level" label="等级" show-overflow-tooltip align="center" width="50">
            </el-table-column>
            <el-table-column prop="damType" label="坝型" show-overflow-tooltip align="center">
            </el-table-column>
            <el-table-column prop="floodControlElevation" label="防洪标高" show-overflow-tooltip align="center">
            </el-table-column>
            <el-table-column prop="legalPersonName" label="法人" show-overflow-tooltip align="center" width='70'>
            </el-table-column>
            <el-table-column prop="legalRepresentativeName" label="上报人" show-overflow-tooltip align="center" width='80'>
            </el-table-column>
            <el-table-column prop="county" label="所在县" show-overflow-tooltip align="center">
            </el-table-column>
            <el-table-column prop="location" label="地理位置" show-overflow-tooltip align="center" width='100'>
            </el-table-column>
            <el-table-column prop="projectSource" label="项目来源" show-overflow-tooltip align="center">
            </el-table-column>
            <el-table-column prop="createTime" label="创建时间" show-overflow-tooltip align="center" width="100" :formatter="formatDate">
            </el-table-column>
            <el-table-column label="总分" prop="score" show-overflow-tooltip align="center" width="80">
                <template slot="header" slot-scope="scope">
                    <!-- <el-input v-model="search" size="mini" placeholder="输入关键字搜索" /> -->
                    <span class="cell-render">总分</span>
                    <div class="cell-icon">
                        <i class="el-icon-arrow-up" @click="totalUp"></i>
                        <i class="el-icon-arrow-down" @click="totalDown"></i>
                    </div>
                </template>
            </el-table-column>
            <el-table-column prop="monthPaperScore" label="月报总分" show-overflow-tooltip align="center" width="105">
                <template slot="header" slot-scope="scope">
                    <!-- <el-input v-model="search" size="mini" placeholder="输入关键字搜索" /> -->
                    <span class="cell-render">月报总分</span>
                    <div class="cell-icon">
                        <i class="el-icon-arrow-up" @click="monthPaperUp"></i>
                        <i class="el-icon-arrow-down" @click="monthPaperDown"></i>
                    </div>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="pagerOp.page" :page-sizes="pageSize" :page-size="pagerOp.rows" layout="total, sizes, prev, pager, next, jumper" background :total="totalElements">
        </el-pagination>
    </div>
</template>
