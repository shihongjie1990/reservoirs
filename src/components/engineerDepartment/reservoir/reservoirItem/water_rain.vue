<template>
    <div class="water-rain">
        <div class="operation-block">
            <div>
                <label>时间段：</label>
                <el-date-picker v-model="time" type="datetimerange" :picker-options="pickerOptions" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" value-format="yyyy-MM-dd HH:mm:ss">
                </el-date-picker>
            </div>
        ...
        <div class="rain-fall">
            <div id="rain_fall" style="width: 100%; height: 300px;"></div>
        </div>
        <div class="water-stage">
            <div id="water_stage" style="width: 100%; height: 300px;"></div>
        </div>
        <div class="flow-rate">
            <div id="flow_rate" style="width: 100%; height: 300px;"></div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        timeChange() {
            ...
            _this.getAllRainFallData(baseInfoId, date).then(res => {
            ...
            _this.getAllWaterLevelData(baseInfoId, date).then(res => {
