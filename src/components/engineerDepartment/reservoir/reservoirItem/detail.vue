<template>
    <div class="detail-block">
        <div class="detail-score">
            <div>
                <span>总评分</span>
                <span>{{ score ? score.score : '00' }}</span>
                <span>分</span>
            </div>
            <div>
                <div>
                    <span>前期工作</span>
                    <div id="preProgresses" style="width:120px;height:120px;"></div>
                </div>
                <div>
                    <span>合同备案</span>
                    <div id="contracts" style="width:120px;height:120px;"></div>
                </div>
                <div>
                    <span>招标管理</span>
                    <div id="tender" style="width:120px;height:120px;"></div>
                </div>
                <div>
                    <span>月报管理</span>
                    <div id="pmrs" style="width:120px;height:120px;"></div>
                </div>
                <div>
                    <span>年度投资</span>
                    <div id="annualInvestments" style="width:120px;height:120px;"></div>
                </div>
            </div>
        </div>
        ...
        <div class="project-progress">
            <div class="date-progress">
                <div>
                    <div>{{ dateRate }}%</div>
                    <el-progress :stroke-width="25" :percentage="dateRate || 0" :text-inside="true"></el-progress>
                </div>
            ...
            <div class="investment-progress">
                <el-row :guter="20">
                    <el-col :lg="6" :md="12" :xs="24">
                        <el-progress type="circle" :percentage="investmentRate || 0" color="#efd766"></el-progress>
                    ...
                    <el-col :lg="6" :md="12" :xs="24">
                        <el-progress type="circle" :percentage="costRate || 0" color="#efd766"></el-progress>
                        <div class="progress-desc">
                            <div>
                                <span>到位资金：</span>
                    ...
                    <el-col :lg="6" :md="12" :xs="24">
                        <el-progress type="circle" :percentage="curInvestmentRate" color="#efd766"></el-progress>
                        <div class="progress-desc">
                            <div>
                                <span>本年投资到位：</span>
                    ...
                    <el-col :lg="6" :md="12" :xs="24">
                        <el-progress type="circle" :percentage="curCostRate" color="#efd766"></el-progress>
                        <div class="progress-desc">
                            <div>
                                <span>本年投资到位：</span>
                                <span>{{ curInvestment || 0 }}</span>
        ...
        <div class="detail-item">
            <el-collapse v-model="activeName" class="panel">
...
export default {
    ...
    methods: {
        getBaseInfoById(baseInfoId) {
            let thisRequest = this.$http.get(`/api/baseinfo/management/${baseInfoId}`)
            return thisRequest
        },
        // 获取生命周期信息
    ...
    mounted() {
        ...
        let dealScore = (score) => {
            ...
            if (parseFloat(scoreNum) < 10) {
                scoreNum = '0' + scoreNum
                score.score = scoreNum
            }
            let dataCompletion = score.dataCompletion
            for (let key in dataCompletion) {
                this.initScoreBall(key, dataCompletion[key])
            }
        }
        if (!score) {
            this.getScore().then(res => {
                let scores = res.data
                let reservoirScore = scores.find(scoreItem => {
                    return scoreItem.baseInfoId === baseInfoId
                })
                this.score = reservoirScore
                dealScore(reservoirScore)
            })
        } else {
            dealScore(score)
        }
