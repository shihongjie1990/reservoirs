<template>
    <div>
        <img src="static/images/wallpaper.jpg" alt="Login" class='logo-bg'>
        <div class='img-word'>
            <span>水利云·监管云</span>
        ...
        <div class='login-block'>
            ...
            <div class='login-content'>
                <img src="static/images/logo-gai.png" alt="监管云Logo" class='login-logo'>
                <div class='login-div'>
                    <div>
                        <!-- <span>用户名：</span> -->
                        <el-input v-model='user' placeholder="请输入用户名">
                            <i slot="prefix" class="fa fa-user-o" style="line-height: 40px; margin-left: 3px;font-size: 17px;"></i>
                        </el-input>
                    </div>
                    <div>
                        <!-- <span>密码：</span> -->
                        <el-input v-model='password' type='password' placeholder="请输入密码" @keyup.native.enter="loginTo">
                            <i slot="prefix" class="fa fa-lock" style="line-height: 40px; margin-left: 3px;font-size: 17px;"></i>
                        </el-input>
                        <el-alert title="账号或密码错误" type="error" show-icon v-show="logErr" @close="closeAlert"></el-alert>
                    </div>
                    <div>
                    </div>
                </div>
                <el-button type="primary" size="small" @click='loginTo'>登陆</el-button>
            </div>
        </div>
    </div>
</template>
